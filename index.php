    ...
    <section id="auth_section">
        ...
        <div class="auth_container">
            ...
            <div id="Log_in">
                <h2>Đăng nhập</h2>
                <div class="role_btn">
                    <div class="btns active">Người dùng</div>
                ...
                <form class="user_login authsection active" id="userlogin" action="" method="POST">
                    ...
                    <div class="footer_line">
                        <h6>Không có tài khoản? <span class="page_move_btn" onclick="signuppage()">Đăng ký</span></h6>
                    </div>
                </form>
            ...
            <div id="sign_up">
                ...
                <form class="user_signup" id="usersignup" action="" method="POST">
                    ...
                    <div class="footer_line">
                        <h6>Đã có tài khoản? <span class="page_move_btn" onclick="loginpage()">Đăng nhập</span></h6>
                    </div>
                </form>
            </div>
    </section>
