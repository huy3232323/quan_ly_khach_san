...
<body>
   <div class="databox">
        <div class="box roombookbox">
          <h2>Tổng số phòng đã đặt</h1>  
          <h1><?php echo $roombookrow ?> / <?php echo $roomrow ?></h1>
        </div>
        <div class="box guestbox">
        <h2>Total Nhân viên</h1>  
          <h1><?php echo $staffrow ?></h1>
        </div>
        <div class="box profitbox">
        <h2>Lợi nhuận</h1>  
          <h1><?php echo $tot?> <span> VND </span></h1>
        </div>
    </div>
    <div class="chartbox">
        <div class="bookroomchart">
            <canvas id="bookroomchart"></canvas>
            <h3 style="text-align: center;margin:10px 0;">Phòng đã đặt</h3>
        </div>
        <div class="profitchart" >
            <div id="profitchart"></div>
            <h3 style="text-align: center;margin:10px 0;">Lợi nhuận</h3>
        </div>
    </div>
</body>
